...
void print(multiset<string> &s, string str){
...
void print(multiset<int> &s, string str){
...
int main(){
    ...
    //multiset , sorted and duplicate values are allowed

    //multiset declaration without value
    //by default sorting order ascending order
    multiset<string> s1;

    //set declaration with value
    multiset<string> s2 = {"abc", "bcd", "gnd", "bcd", "dht"};
    print(s2, "Multi Set Declaration with value");
...
/*--------------------------Deleting element----------------------*/
    //o(log(n))
    // if(it != s1.end()){
    //     s1.erase(it); // passing iterator //it will delete only 1st occurence
    // }
    // print(s1, "Deleting element");

    //internally running iterator
    s1.erase("abc"); // it will delete all occurence of abc
    print(s1, "Deleting all occurence of abc");
